...
# Gazebo plugin path (required for spawn_entity service)
export GAZEBO_PLUGIN_PATH=/opt/ros/humble/lib:$GAZEBO_PLUGIN_PATH

# Gazebo model paths (include default models for ground_plane, sun, etc.)
export GAZEBO_MODEL_PATH=/usr/share/gazebo-11/models:/opt/ros/humble/share:$GAZEBO_MODEL_PATH

# Disable online model database (prevents timeout hanging)
export GAZEBO_MODEL_DATABASE_URI=""

# Software rendering for container compatibility
...
echo ""
echo "Gazebo configuration:"
echo "  - Software rendering: enabled"
echo "  - Plugin path: configured"
echo "  - Model path: configured"
echo "  - Online database: disabled"
echo "=========================================="