...
# Quick verification script for TurtleBot3 Humble setup
# Run this after container is built to verify everything works

echo "=========================================="
echo "TurtleBot3 Humble Setup Verification"
echo "=========================================="
echo ""
...
if test_command "ROS2 Humble installed" "ros2 --version"; then
    ((passed++))
else
    ((failed++))
fi

if test_command "Gazebo Classic installed" "gazebo --version"; then
    ((passed++))
else
    ((failed++))
fi
...
if [ $failed -eq 0 ]; then
    ...
    echo ""
    echo "Your TurtleBot3 Humble environment is ready!"
    echo ""
    echo "Quick start:"
